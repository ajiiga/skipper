...
const FreeCalendarPicker = ({calendarState, setCalendarState}) => {
    return (
        <div>
            <div className={s.date}>декабрь, 27 - январь, 2</div>
                                            ...
                                            week.map((day, j) => <div key={j}
                                                                      ...
                                                                      onClick={() => {
                                                                          if (calendarState[i][j] !== 0) {
                                                                              ...
                                                                              deltaCalendarState[i][j] = deltaCalendarState[i][j] === 2 ? 1 : 2
