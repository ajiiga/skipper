...
const SelectCountLesson = ({
  ...
  let handleBtn = (min, count) => {
    ...
    deltaTimeLessons[`min${min}`][`count${count}`] =
      !deltaTimeLessons[`min${min}`][`count${count}`];
  ...
  return (
    <div className={s.count_lesson_container}>
      {lesson.Duration15 && (
        <div className={s.count_lesson_block}>
          <div className={s.count_lesson_block_title}>
            15 минут (пробное занятие)
          </div>
          <div>
            <div
              className={`${s.count_lesson_block_button} ${
                timeLessons.min15.count1 ? s.count_lesson_block_active : ""
              }`}
      ...
      {lesson.Duration30 && (
        <div className={s.count_lesson_block}>
          ...
          <div>
            <div
              className={`${s.count_lesson_block_button} ${
                timeLessons.min30.count1 ? s.count_lesson_block_active : ""
              }`}
            ...
            <div
              className={`${s.count_lesson_block_button} ${
                timeLessons.min30.count3 ? s.count_lesson_block_active : ""
              }`}
            ...
            <div
              className={`${s.count_lesson_block_button} ${
                timeLessons.min30.count5 ? s.count_lesson_block_active : ""
              }`}
      ...
      {lesson.Duration60 && (
        <div className={s.count_lesson_block}>
          ...
          <div>
            <div
              className={`${s.count_lesson_block_button} ${
                timeLessons.min60.count1 ? s.count_lesson_block_active : ""
              }`}
            ...
            <div
              className={`${s.count_lesson_block_button} ${
                timeLessons.min60.count3 ? s.count_lesson_block_active : ""
              }`}
            ...
            <div
              className={`${s.count_lesson_block_button} ${
                timeLessons.min60.count5 ? s.count_lesson_block_active : ""
              }`}
      ...
      {lesson.Duration90 && (
        <div className={s.count_lesson_block}>
          ...
          <div>
            <div
              className={`${s.count_lesson_block_button} ${
                timeLessons.min90.count1 ? s.count_lesson_block_active : ""
              }`}
            ...
            <div
              className={`${s.count_lesson_block_button} ${
                timeLessons.min90.count3 ? s.count_lesson_block_active : ""
              }`}
            ...
            <div
              className={`${s.count_lesson_block_button} ${
                timeLessons.min90.count5 ? s.count_lesson_block_active : ""
              }`}
