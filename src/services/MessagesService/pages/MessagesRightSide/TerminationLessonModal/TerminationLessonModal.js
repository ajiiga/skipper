    ...
    return (
        <MessageModalContainer id={id} title={'Прекращение занятий'}>
            <div className={s.terminate_lesson_container}>
                <div className={s.terminate_lesson_title}>Увы, но второй пользователь решил прекратить занятия</div>
                <img src={img} alt=""/>
                <div className={s.resume_lesson_content}>Оставшиеся денежные средства в скором времени вернутся на Ваш
                    счет
                </div>
            </div>
