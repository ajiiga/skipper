...
const MyClassesMentor = () => {
  ...
  return (
    <div className={s.container}>
      {width <= 500 ? (
        <div className={s.miniNavBar_container}>
        ...
        <div className={s.title_buttons}>
          <Link
            className={`${s.title_btn} ${
              location.pathname === "/my-classes-mentor/consideration"
                ? s.active_title_btn
                : ""
            }`}
            to={"/my-classes-mentor/consideration"}
          >
            <div>На рассмотрении</div>
          </Link>
          <Link
            className={`${s.title_btn} ${
              location.pathname === "/my-classes-mentor/planned"
                ? s.active_title_btn
                : ""
            }`}
            to={"/my-classes-mentor/planned"}
          >
            <div>Запланированные</div>
          </Link>
          <Link
            className={`${s.title_btn} ${
              location.pathname === "/my-classes-mentor/completed"
                ? s.active_title_btn
                : ""
            }`}
            to={"/my-classes-mentor/completed"}
          >
            <div>Завершенные</div>
          </Link>
          <Link
            className={`${s.title_btn} ${
              location.pathname === "/my-classes-mentor/canceled"
                ? s.active_title_btn
                : ""
            }`}
            to={"/my-classes-mentor/canceled"}
          >
            <div>Отмененнные</div>
          </Link>
          {width > 500 && (
