...
const CanceledItem = ({ data, deleteItem }) => {
  let deleteClass = () => {
    myClassesStore
      .changeStatusClass(data.ID, "archived")
      .then((x) => deleteItem());
  };

  let resumeClass = () => {
    myClassesStore
      .changeStatusClass(data.ID, "planned")
      .then((x) => deleteItem());
  };
  ...
  return (
    <div className={s.container}>
      <div className={s.title_container}>
        ...
        <button className={s.right_title_btn} onClick={() => deleteClass()}>
          Удалить
        </button>
      </div>
      ...
      <div className={s.communication_price_container}>
        <div className={s.communication_container}>
          ...
          <div className={s.communication_user_id}>
            User id: {data.communication_login}
          </div>
        </div>
      ...
      <div className={s.under_container}>
        ...
        <div className={s.button_containers}>
          ...
          <button className={s.confirm_btn} onClick={() => resumeClass()}>
            Возобновить
          </button>
        </div>
      </div>
